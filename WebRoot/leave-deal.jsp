                    ...
                    <div class="span9 with-sidebar">
                        <div class="container">
							<form id="ff" method="post" class="new_user_form inline-input" />
	                            <div class="field-box">
	                            <label>姓名:</label>
	                            <input hidden="hidden" name="lestate" value="${leaPShow.lestate}">
	                            <input class="span5 inline-input" type="text" name="leemname" value="${leaPShow.leemname}" />
	                        	</div>
								<div class="field-box">
                                <label>开始时间:</label>
                                <input hidden="hidden" name="leaveId" value="${leaPShow.leaveId}">
                                <input type="text" name="begintime"
										value="${leaPShow.begintime}" class="input-large datepicker" />
                            	</div>
                            	<div class="field-box">
                                <label>结束时间:</label>
                                <input type="text" name="endtime" value="${leaPShow.endtime}"
										class="input-large datepicker" />
                            	</div>
                                <div class="span12 field-box textarea">
                                    <label>请假原因:</label>
                                    <textarea class="span9"
										name="reasaon">${leaPShow.reasaon}</textarea>
                                    <span class="charactersleft">填写限制在100个字</span>
                                </div>
                                <div class="span11 field-box actions">
                                    <input id="yes" type="button"
										class="btn-glow primary" value="同意" />
                                    <span>或</span>
                                    <input id="no" type="button"
										class="btn-glow primary" value="驳回" />
                                </div>
                            </form>
                        </div>
                    </div>
