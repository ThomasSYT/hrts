        ...
        <div class="navbar-inner">
            ...
            <div class="nav-collapse collapse">
                <ul class="nav">
                    ...
                    <li><a href="chart-showcase.jsp">Charts</a></li>
                    <li><a href="user-list.jsp">Users</a></li>
                    <li><a href="form-showcase.jsp">Forms</a></li>
                    <li><a href="gallery.jsp">Gallery</a></li>
                    <li><a href="icons.jsp">Icons</a></li>
                    <li><a href="calendar.jsp">Calendar</a></li>
                    <li><a href="tables.jsp">Tables</a></li>
                    <li><a href="ui-elements.jsp">UI Elements</a></li>
                </ul>
            </div>
            <ul class="nav pull-right">
                ...
                <li id="fat-menu" class="dropdown">
                    <a href="signin.jsp" role="button" class="logout">
                        <span class="navbar_icon"></span>
                    </a>
                </li>
            </ul>
