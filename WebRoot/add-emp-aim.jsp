                    ...
                    <div class="span9 with-sidebar">
                        <div class="container">
                            <form id="ff" method="post" />
                                ...
                                <div class="span12 field-box">
                                    <label>基本目标:</label>
                                    <input class="span9" type="text" name="basetarget"/>
                                </div>
                                <div class="span12 field-box textarea ">
                                    <label>目标内容:</label>
                                    <textarea class="span9" name="basetext"></textarea>
                                    <span class="charactersleft" >填写限制在100个字</span>
                                </div>
                                <div class="span12 field-box">
                                    <label>挑战性目标:</label>
                                    <input class="span9" type="text" name="challengetarget"/>
                                </div>
                                <div class="span12 field-box textarea">
                                    <label>目标内容:</label>
                                    <textarea class="span9" name="challengetext"></textarea>
                                    <span class="charactersleft">填写限制在100个字</span>
                                </div>
                                <div class="field-box">
                                <label>开始时间:</label>
                                <input type="text" name="begintime" class="input-large datepicker" />
                            	</div>
                                <div class="field-box">
                                <label>截至时间:</label>
                                <input type="text" name="deadline" class="input-large datepicker" />
                            	</div>
