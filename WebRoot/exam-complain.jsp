                        ...
                        <div class="container">
                            <form id="ff" method="post" class="new_user_form inline-input" />
                                <div class="span12 field-box">
                                    <label>申诉人姓名:</label>
                                    <input disabled="disabled" name="coName" class="span9" type="text" value="${employee.emName}"/>
                                </div>
                                <div class="field-box">
                                <label>申诉时间:</label>
                                <input type="text" name="cotime" class="input-large datepicker" />
                            	</div>
                                <div class="span12 field-box textarea">
                                    <label>申诉原因:</label>
                                    <textarea class="span9" name="coText"></textarea>
                    ...
                    <div class="span3 form-sidebar pull-right">
                        ...
                        <div class="alert alert-info hidden-tablet">
                            <i class="icon-lightbulb pull-left"></i>
                            	认真填写信息后，系统将提交您的申诉请求，请您耐心等候申诉结果。
                        </div>                        
                    </div>
                </div>
            </div>
