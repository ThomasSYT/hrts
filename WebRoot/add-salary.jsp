                        ...
                        <div class="container">
                            <form id="ff" method="post" >
                                <div class="span12 field-box">
                                    ...
                                    <div class="ui-select">
										<select name="emId">
											<c:forEach items="${ulist}" varStatus="list">
												<option value=${ulist[list.index].emId}>${ulist[list.index].emName}</option>
											</c:forEach>
										</select>
									</div>
                                </div>
                                <div class="span12 field-box">
                                    <label>基本工资:</label>
                                    <input name="payBaseMoney" class="span9" type="text" />
                                </div>
                                <div class="span12 field-box">
                                    <label>加班费:</label>
                                    <input name="payOvertime" class="span9" type="text" />
                                </div>
                                <div class="span12 field-box">
                                    <label>保险:</label>
                                    <input name="paySafety" class="span9" type="text" />
                                </div>
                                <div class="span12 field-box">
                                    <label>补助:</label>
                                    <input name="payAbsent" class="span9" type="text" />
                                </div>
                                <div class="field-box">
                                <label>发薪日:</label>
                                <input name="payMonth" type="text" value="03/29/2014" class="input-large datepicker" />
                            	</div>
